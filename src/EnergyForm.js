    ...
    return(
        <form onChange={handleOnChange} className='initialForm'>
            <span>
                ...
                <input type="number" id="heatingCount" name="energy" max="12" min="0" defaultValue={formValues["heatingCount"] ? formValues["heatingCount"] :"" } required/>
            </span>
            <span>
                <label htmlFor="coolingCount">How many months a year do you use air conditioning?</label><br/>
                <input type="number" id="coolingCount" name="energy" max="12" min="0" defaultValue={formValues["coolingCount"] ? formValues["coolingCount"] :"" } required/>
            </span>
            <span>
